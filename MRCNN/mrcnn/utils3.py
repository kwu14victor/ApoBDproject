...
def generate_anchors(scales, ratios, shape, feature_stride, anchor_stride):
    ...
    depths = scales / (ratios ** (1/3))  #10/03 edited
    ...
    print(box_widths.shape, box_centers_x.shape,box_heights.shape, box_centers_y.shape,box_depths.shape, box_centers_z.shape)
